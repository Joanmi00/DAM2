...
private int fila;     // fila en la que se encuentra la celda
private int columna;  // Columna en la que se eunentra la celda
private int contains; //Contenido de la celda
