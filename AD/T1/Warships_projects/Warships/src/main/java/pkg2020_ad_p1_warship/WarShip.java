...
private void exportar() {
  ...
  try {
    ...
    // Obtenemos y escribimos en el archivo warship las propiedades de la partida
    bw.write("board_tam=" + Board.getBoardDim() + "\n");
    bw.write("num_boats=" + Board.getBoardBoatsCount() + "\n");
    bw.write("max_jugadas=" + MAX_JUGADAS);
...
private void importar() {
  ...
  try {
    ...
    int board_tam = Integer.parseInt(configuracion.getProperty("board_tam"));
    Board.setBoardDim(board_tam);
    int num_boats = Integer.parseInt(configuracion.getProperty("num_boats"));
    Board.setBoardBoatsCount(num_boats);
