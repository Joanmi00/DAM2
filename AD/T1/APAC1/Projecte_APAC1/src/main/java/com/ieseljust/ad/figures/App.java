...
/**
 * App.java: Es tracta del punt d’entrada a l’aplicació,
 * qui s’encarrega de mostrar el prompt i crear l’Escena,
 * formada per la llista de figures.
 * En principi, en aquesta classe no caldrà modificar res.
 */
